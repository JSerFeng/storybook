...
} from '@storybook/core-rspack';

export type { BuilderResult } from '@storybook/core-rspack';
...
// TODO: maybe need to impl a SWC plugin to support this
...
export type StorybookConfig<TRspackConfiguration = RspackConfigurationBase> =
  StorybookConfigBase<TRspackConfiguration>;
//  & {
